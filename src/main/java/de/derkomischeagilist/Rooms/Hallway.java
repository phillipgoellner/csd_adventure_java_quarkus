...
public class Hallway extends AbstractRoom {
    ...
    public String getDetailedDescription() {
        return "You see 3 doors. One door leads to the kitchen, one to the washroom. " +
                "At the end you see a spooky looking door. On one of the walls there is a dirty poster.";
    }
    ...
    public String handleCommand(String command) {
        switch (command.toLowerCase()) {
            case "inspect the spooky door":
                return "You see a rugged and sturdy steel door with cryptic symbols on it. Above the door is a sign saying <b>EXIT</b>. "
            ...
            case "inspect the poster":
                //return "There are 5 SCRUM values!";
                return  "<span>~~^^~~~~ ~~~~~^^^^~~~ ~~~~~^^^~~</span>\n" +
                        "We pinned the 5&#65039;&#8419 mighty Scrum \n" +
                        "Values, they are : \n" +
                        "  <span style=\'margin-left:200px\'> • Commitment</span>\n" +
                        "  <span style=\'margin-left:160px\'> • Courage</span>\n" +
                        "  <span style=\'margin-left:120px\'> • Focus</span>\n" +
                        "  <span style=\'margin-left:80px\'> • Openness</span>\n" +
                        "  <span style=\'margin-left:40px\'> • Respect</span>\n" +
                        "<span>^^~~~~~~~~~~~^^^ ~~~~~~~~~~~~~~^^</span>\n";
            case "use keypad":
    ...
    private String handleDefaultCase(String command) {
        if (keypadIsActive) {
            resetKeypad();
            // team decided that song number 17 is the new exit code

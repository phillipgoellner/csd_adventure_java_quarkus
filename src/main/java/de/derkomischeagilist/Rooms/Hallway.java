...
public class Hallway extends AbstractRoom {
    ...
    public String getDetailedDescription() {
        return "Welcome to the very dark hallway to hell. You see 3 doors. One door leads to the kitchen, one to the washroom. At the end you see a spooky looking door.";
    }
